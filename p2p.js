...
var rPeerButton = document.getElementById('rPeerButton');
...
seedButton.onclick = function(){addSeeder()};
peerButton.onclick = function(){addPeer()};
rPeerButton.onclick = function(){removePeer()};
